                    ...
                    <div class="row">
                        <article class="featured-post is-sticky" data-id="<?php echo esc_attr( $post_to_get ); ?>">
                            ...
                            <div class="post-element">
                                ...
                                <h2 class="post-title"><a href="<?php the_permalink($post_to_get); ?>" title="<?php the_title_attribute(array('post'  => $post_to_get)); ?>"><?php echo wp_kses(get_the_title($post_to_get), [ 'em' => [], 'strong' => [], 'span' => [], 'br' => [] ] ); ?></a></h2>
                                <div class="post-meta">
                                    <?php
